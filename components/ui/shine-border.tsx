...
export default function ShineBorder({
  ...
  return (
    <div
      ...
      className={cn(
        "relative grid min-h-[60px] w-fit min-w-[300px] place-items-center rounded-[--border-radius] bg-gradient-to-br from-neutral-900/80 to-background p-3 text-foreground",
        className,
      )}
    >
      <div
