...
export default function Home() {
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-items-center gap-12 overflow-x-clip scroll-smooth bg-secondary p-4 font-[family-name:var(--font-geist-sans)] dark:bg-background md:gap-20">
